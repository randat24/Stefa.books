-- ============================================================================
-- МИНИМАЛЬНЫЙ ЗАГРУЗЧИК КНИГ
-- ============================================================================
-- Использует только самые базовые колонки, которые точно есть в таблице books
...
-- 2. Загружаем книги (только с минимальными колонками)
