...
export default function TestImportPathPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Тест шляхів імпорту BookCard</h1>
        ...
        <div>
          ...
          <div className="border p-4 rounded">
            {typeof BookCardDefault === 'function' ? (
              <div>
                <p className="text-green-600 mb-2">Default import successful</p>
                <BookCardDefault book={sampleBook} />
              </div>
            ) : (
              <p className="text-red-600">
                Default import failed. Type: {typeof BookCardDefault}
              </p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="border p-4 rounded">
            {typeof BookCardNamed === 'function' ? (
              <div>
                <p className="text-green-600 mb-2">Named import successful</p>
                <BookCardNamed book={sampleBook} />
              </div>
            ) : (
              <p className="text-red-600">
                Named import failed. Type: {typeof BookCardNamed}
              </p>
            )}
          </div>
        </div>
