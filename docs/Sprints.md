...
## Спринт 6. Оптимизация производительности (5–7 дней) 🔄 В ПРОЦЕССЕ
...
**Объём**
- `[ ]` **(CRITICAL)** Исправление TypeScript ошибок (163 ошибки в 22 файлах)
- `[ ]` **(HIGH)** Оптимизация bundle size (цель: -20-30%)
- `[ ]` **(HIGH)** Улучшение Core Web Vitals (LCP < 2.0s, FID < 50ms)
- `[ ]` **(MEDIUM)** Внедрение мониторинга производительности
- `[ ]` **(MEDIUM)** Оптимизация изображений и ресурсов
...
**Риски**
- Конфликты типов React 18/19
- Сложность оптимизации существующего кода
