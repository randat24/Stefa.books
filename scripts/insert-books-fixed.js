...
/**
 * Исправленная вставка книг в базу данных через Supabase API
 * С добавлением обязательного поля code
 */
...
// Данные о книгах с добавленным полем code
const booksData = [
  {
    code: 'PL-001',
...
async function main() {
  console.log('📚 Скрипт вставки книг в Stefa.Books (исправленная версия)\n');
