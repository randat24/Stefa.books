-- ============================================================================
-- ПОЛНЫЙ ЗАГРУЗЧИК КНИГ С ВСЕМИ КОЛОНКАМИ
-- ============================================================================
-- Сначала выполните check_and_fix_books_table.sql для добавления недостающих колонок
...
-- 2. Загружаем книги с полным набором колонок
...
-- Книга 1
('Пригоди Тома Сойєра', 'Марк Твен', '978-617-12-3456-7', 'Класичний роман про пригоди хлопчика Тома Сойєра в містечку Сент-Пітерсберг', 'Пригоди хлопчика Тома Сойєра', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/tom-sawyer.jpg', find_category_by_parts('Пригоди, молодший вік'), true, 'SB-2025-0001', '8-12 років', 320, 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2020, 3, 3, 15.00, 80.00, 200.00, 150.00, 'Полиця А-1', ARRAY['пригоди', 'класика', 'молодший вік'], ARRAY['популярна', 'нова'], 'available'),
