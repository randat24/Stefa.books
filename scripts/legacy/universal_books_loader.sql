-- ============================================================================
-- УНИВЕРСАЛЬНЫЙ ЗАГРУЗЧИК КНИГ
-- ============================================================================
-- Работает с любой структурой таблицы books
...
-- 2. Загружаем книги (только с базовыми колонками)
...
-- Книга 1
('Пригоди Тома Сойєра', 'Марк Твен', '978-617-12-3456-7', 'Класичний роман про пригоди хлопчика Тома Сойєра в містечку Сент-Пітерсберг', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/tom-sawyer.jpg', find_category_by_parts('Пригоди, молодший вік'), true, 'SB-2025-0001', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2020, ARRAY['пригоди', 'класика', 'молодший вік'], ARRAY['популярна', 'нова'], 'available'),

-- Книга 2
('Аліса в Країні Чудес', 'Льюїс Керролл', '978-617-12-3457-4', 'Казкова історія про дівчинку Алісу, яка потрапила в фантастичний світ', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/alice.jpg', find_category_by_parts('Казки, дошкільний вік'), true, 'SB-2025-0002', 'uk', 'Видавництво Старого Лева', 2019, ARRAY['казки', 'фантастика', 'дошкільний вік'], ARRAY['класика'], 'available'),

-- Книга 3
('Гаррі Поттер і філософський камінь', 'Джоан Роулінг', '978-617-12-3458-1', 'Перша книга про пригоди юного чарівника Гаррі Поттера в школі чарівництва Хогвартс', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/harry-potter.jpg', find_category_by_parts('Фентезі, підлітковий вік'), true, 'SB-2025-0003', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2021, ARRAY['фентезі', 'магія', 'підлітковий вік'], ARRAY['популярна', 'бестселер'], 'available'),

-- Книга 4
('Детективна історія', 'Автор Детектив', '978-617-12-3459-8', 'Захоплюючий детектив про розслідування загадкового злочину', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/detective.jpg', find_category_by_parts('Детектив, середній вік'), true, 'SB-2025-0004', 'uk', 'Видавництво Старого Лева', 2022, ARRAY['детектив', 'загадка', 'середній вік'], ARRAY['нова'], 'available'),

-- Книга 5
('Книга про психологію', 'Психолог Автор', '978-617-12-3460-4', 'Книга про психологію та саморозвиток для підлітків', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/psychology.jpg', find_category_by_parts('Психологія і саморозвиток'), true, 'SB-2025-0005', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2023, ARRAY['психологія', 'саморозвиток', 'підлітковий вік'], ARRAY['корисна'], 'available'),

-- Книга 6
('Маленький принц', 'Антуан де Сент-Екзюпері', '978-617-12-3461-1', 'Філософська казка про маленького принца з далекої планети', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/little-prince.jpg', find_category_by_parts('Казки, дошкільний вік'), true, 'SB-2025-0006', 'uk', 'Видавництво Старого Лева', 2020, ARRAY['казки', 'філософія', 'дошкільний вік'], ARRAY['класика', 'мудра'], 'available'),

-- Книга 7
('Відьмак', 'Анджей Сапковський', '978-617-12-3462-8', 'Фентезійний роман про мисливця на монстрів Геральта з Рівії', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/witcher.jpg', find_category_by_parts('Фентезі, підлітковий вік'), true, 'SB-2025-0007', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2022, ARRAY['фентезі', 'пригоди', 'підлітковий вік'], ARRAY['популярна', 'екранізація'], 'available'),

-- Книга 8
('Шерлок Холмс', 'Артур Конан Дойл', '978-617-12-3463-5', 'Збірка детективних оповідань про знаменитого детектива Шерлока Холмса', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/sherlock.jpg', find_category_by_parts('Детектив, середній вік'), true, 'SB-2025-0008', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2021, ARRAY['детектив', 'класика', 'середній вік'], ARRAY['класика', 'знаменита'], 'available'),

-- Книга 9
('Як навчитися програмувати', 'Програміст Автор', '978-617-12-3464-2', 'Практичний посібник з програмування для початківців', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/programming.jpg', find_category_by_parts('Пізнавальні, середній вік'), true, 'SB-2025-0009', 'uk', 'Видавництво Старого Лева', 2023, ARRAY['програмування', 'технології', 'навчання'], ARRAY['корисна', 'сучасна'], 'available'),

-- Книга 10
('Сучасна проза', 'Сучасний Автор', '978-617-12-3465-9', 'Сучасний роман про життя сучасних підлітків', 'https://res.cloudinary.com/your-cloud/image/upload/v1234567890/modern-prose.jpg', find_category_by_parts('Сучасна проза'), true, 'SB-2025-0010', 'uk', 'А-БА-БА-ГА-ЛА-МА-ГА', 2023, ARRAY['сучасна проза', 'підлітковий вік'], ARRAY['нова'], 'available')
