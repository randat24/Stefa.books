...
async function main() {
  ...
  if (args.includes('--show')) {
    ...
    console.log('1. Edit the coverData array in this file with your Cloudinary URLs');
    console.log('2. Run: node final_cloudinary_import.mjs');
    console.log('3. Or show current covers: node final_cloudinary_import.mjs --show\n');
