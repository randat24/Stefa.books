-- ============================================================================
-- БЫСТРЫЙ ЗАГРУЗЧИК КНИГ ИЗ GOOGLE SHEETS
-- ============================================================================
...
-- Книга 1
INSERT INTO public.books (title, author, isbn, description, cover_url, category_id, available, code, age_range, pages, language, publisher, publication_year, qty_total, qty_available, price_daily, price_weekly, price_monthly, price_uah, location, tags, badges) 
SELECT 
    'Пригоди Тома Сойєра',
    'Марк Твен',
    '978-617-12-3456-7',
    'Класичний роман про пригоди хлопчика Тома Сойєра в містечку Сент-Пітерсберг',
    ...
    150.00,
    'Полиця А-1',
    ARRAY['пригоди', 'класика', 'молодший вік'],
    ARRAY['популярна', 'нова']
...
SELECT 
    ...
    'Льюїс Керролл',
    '978-617-12-3457-4',
    'Казкова історія про дівчинку Алісу, яка потрапила в фантастичний світ',
    ...
    120.00,
    'Полиця Б-2',
    ARRAY['казки', 'фантастика', 'дошкільний вік'],
    ARRAY['класика']
...
SELECT 
    ...
    'Джоан Роулінг',
    '978-617-12-3458-1',
    'Перша книга про пригоди юного чарівника Гаррі Поттера в школі чарівництва Хогвартс',
    ...
    200.00,
    'Полиця В-3',
    ARRAY['фентезі', 'магія', 'підлітковий вік'],
    ARRAY['популярна', 'бестселер']
...
SELECT 
    ...
    'Автор Детектив',
    '978-617-12-3459-8',
    'Захоплюючий детектив про розслідування загадкового злочину',
    ...
    180.00,
    'Полиця Г-4',
    ARRAY['детектив', 'загадка', 'середній вік'],
    ARRAY['нова']
...
SELECT 
    ...
    'Психолог Автор',
    '978-617-12-3460-4',
    'Книга про психологію та саморозвиток для підлітків',
    ...
    250.00,
    'Полиця Д-5',
    ARRAY['психологія', 'саморозвиток', 'підлітковий вік'],
    ARRAY['корисна']
