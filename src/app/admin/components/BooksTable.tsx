                ...
                <TableBody>
                  {paginatedBooks.map((book, index) => (
                    ...
                    >
                      ...
                      <TableCell className="p-4">
                        {book.publisher ? (
                          <div className="inline-flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 rounded-full text-xs font-medium border border-purple-200">
                      ...
                      {/* Всього */}
                      <TableCell className="text-center p-4">
                        <div className="inline-flex items-center justify-center w-8 h-8 bg-gray-100 text-gray-700 rounded-full text-sm font-bold border border-gray-200">
                          {book.qty_total || 0}
                        </div>
                      </TableCell>
                      ...
                      {/* Доступно */}
                      <TableCell className="text-center p-4">
                        <div className={`inline-flex items-center justify-center w-8 h-8 rounded-full text-sm font-bold border ${
                      ...
                      <TableCell className="text-right p-4">
                        {book.full_price_uah ? (
                          <div className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 rounded-full font-bold text-sm border border-blue-200 shadow-sm">
                      ...
                      <TableCell className="p-4">
                        {book.location ? (
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm text-gray-600 font-medium truncate max-w-[100px]" title={book.location}>
                              {book.location}
                            </div>
                          </div>
                        ) : (
