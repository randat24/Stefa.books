				...
				<div className="space-y-8">
					<section>
						...
						<p className="text-body-lg text-neutral-700 leading-relaxed">
							...
							<code className="bg-neutral-100 px-2 py-1 rounded text-sm">::selection</code> и 
							<code className="bg-neutral-100 px-2 py-1 rounded text-sm">::-moz-selection</code>.
						</p>
					</section>
					...
					<section>
						...
						<div className="space-y-2 text-sm">
							<p><code className="bg-neutral-100 px-2 py-1 rounded">.highlight</code> - основной фирменный желтый</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">.highlight-light</code> - светлый вариант</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">.selection-brand</code> - для настройки выделения текста</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">.selection-brand-light</code> - светлый вариант выделения</p>
						</div>
					</section>
					...
					<section>
						...
						<div className="space-y-2 text-sm">
							<p><code className="bg-neutral-100 px-2 py-1 rounded">bg-accent</code> - основной желтый фон</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">bg-accent-light</code> - светлый желтый фон</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">bg-accent-dark</code> - темный желтый фон</p>
							<p><code className="bg-neutral-100 px-2 py-1 rounded">text-brand</code> - темный текст на желтом фоне</p>
						</div>
					</section>
				</div>
			</div>
