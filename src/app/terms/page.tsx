      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-neutral-0 rounded-3xl shadow-xl p-8 lg:p-12">
          ...
          <div className="text-center mb-8">
            <p className="text-neutral-600 mb-2">Для сайту Stefa.books</p>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Предмет Угоди</h2>
              <div className="space-y-4">
                <p className="text-neutral-700 leading-relaxed">
                  Stefa.books надає Користувачам можливість:
                </p>
                <ul className="list-disc list-inside text-neutral-700 ml-4 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Видача та повернення книг</h2>
              <div className="space-y-4 text-neutral-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Права та обов&rsquo;язки сторін</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-3">Stefa.books зобов&rsquo;язується:</h3>
                ...
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-3">Користувач зобов&rsquo;язується:</h3>
                  <ul className="list-disc list-inside text-neutral-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Інтелектуальна власність</h2>
              <div className="space-y-4 text-neutral-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Зміни до Умов</h2>
              <div className="space-y-4 text-neutral-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Форс-мажорні обставини</h2>
              <div className="space-y-4 text-neutral-700 leading-relaxed">
