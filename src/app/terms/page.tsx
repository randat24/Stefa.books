      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Права та обов&rsquo;язки сторін</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Stefa.books зобов&rsquo;язується:</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-3">Користувач зобов&rsquo;язується:</h3>
                  <ul className="list-disc list-inside text-slate-700 space-y-2">
