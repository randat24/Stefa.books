      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
          ...
          <div className="text-center mb-8">
            <p className="text-neutral-600 mb-2">Документ для сайту Stefa.books</p>
            <p className="text-body-sm font-semibold text-accent-dark">Дата набрання чинності: 27 серпня 2025 року</p>
          </div>

          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Загальні положення</h2>
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Які дані ми збираємо</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-2">Ідентифікаційні дані</h3>
                ...
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-2">Контактні дані</h3>
                  <ul className="list-disc list-inside text-neutral-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-2">Платіжні дані</h3>
                  <ul className="list-disc list-inside text-neutral-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-2">Дані для користування сервісом</h3>
                  <ul className="list-disc list-inside text-neutral-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-body-lg font-semibold text-neutral-900 mb-2">Технічні дані</h3>
                  <ul className="list-disc list-inside text-neutral-700 ml-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Мета обробки персональних даних</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Правові підстави для обробки даних</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Як ми зберігаємо та захищаємо дані</h2>
              <ul className="list-disc list-inside text-neutral-700 space-y-2">
                <li>Дані зберігаються на захищених серверах (використовуються Supabase, Cloudinary, Netlify).</li>
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Розкриття інформації третім особам</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Ваші права як суб&rsquo;єкта персональних даних</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
                Ви маєте право:
              </p>
              <ul className="list-disc list-inside text-neutral-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Використання cookies та аналітики</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Міжнародна передача даних</h2>
              <p className="text-neutral-700 leading-relaxed">
                У випадку передачі персональних даних за межі України (зокрема, при використанні сервісів Supabase, Netlify, Cloudinary), ми забезпечуємо адекватний рівень захисту таких даних шляхом укладання договорів про обробку персональних даних (Data Processing Agreements) та застосування технічних і організаційних заходів захисту.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Відповідальність</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Зміни до Політики</h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Процедура розгляду скарг</h2>
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Юрисдикція та вирішення спорів</h2>
              <div className="space-y-4 text-neutral-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-h2 text-neutral-900 mb-4">Контакти</h2>
              <p className="text-neutral-700 leading-relaxed mb-4">
