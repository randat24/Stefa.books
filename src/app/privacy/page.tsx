      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12">
          ...
          <div className="text-center mb-8">
            <p className="text-slate-600 mb-2">Документ для сайту Stefa.books</p>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Які дані ми збираємо</h2>
              <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Контактні дані</h3>
                  <ul className="list-disc list-inside text-slate-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Платіжні дані</h3>
                  <ul className="list-disc list-inside text-slate-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Дані для користування сервісом</h3>
                  <ul className="list-disc list-inside text-slate-700 ml-4 space-y-1">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Технічні дані</h3>
                  <ul className="list-disc list-inside text-slate-700 ml-4 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Мета обробки персональних даних</h2>
              <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Правові підстави для обробки даних</h2>
              <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Як ми зберігаємо та захищаємо дані</h2>
              <ul className="list-disc list-inside text-slate-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Використання cookies та аналітики</h2>
              <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Зміни до Політики</h2>
              <p className="text-slate-700 leading-relaxed">
