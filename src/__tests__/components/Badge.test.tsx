...
describe('Badge Component', () => {
  ...
  it('should apply secondary variant styling', () => {
    ...
    expect(badge).toHaveClass('bg-slate-800', 'text-slate-50');
  });
  ...
  it('should apply destructive variant styling', () => {
    ...
    expect(badge).toHaveClass('bg-red-500', 'text-slate-50');
  });
  ...
  it('should apply outline variant styling', () => {
    ...
    expect(badge).toHaveClass('border', 'border-slate-200', 'bg-transparent');
  });
