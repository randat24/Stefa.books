...
import { Search, Filter, Grid3X3, List, MoreHorizontal, RefreshCw, Settings, Download, Upload, Trash2, Edit, Plus, Monitor, Activity } from 'lucide-react'
...
interface OptimizedDataProviderProps<T> {
  data: T[]
