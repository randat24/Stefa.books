      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">Код книги:</span>
          ...
          {book.age_range && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">Вікова група:</span>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">У наявності:</span>
          ...
          {book.location && (
            <div className="flex items-center gap-2 sm:col-span-2">
              ...
              <span className="text-gray-600">Розташування:</span>
