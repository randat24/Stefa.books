				...
				<div className="relative overflow-hidden rounded-3xl border border-line p-8 lg:p-12 bg-white shadow-soft">
					<div className="grid gap-8 lg:grid-cols-2 items-center">
						...
						<div>
							...
							{/* Список преимуществ */}
							<ul className="grid gap-3 text-body-sm text-text mt-6">
								<li className="flex items-center gap-2">
									<span className="size-2 rounded-2xl bg-accent" /> Гнучкі плани — без прихованих платежів
								</li>
								<li className="flex items-center gap-2">
									<span className="size-2 rounded-2xl bg-brand" /> Зручна точка видачі
								</li>
								<li className="flex items-center gap-2">
							...
							<div className="mt-6 flex flex-wrap gap-3">
								<Link href="/books#top" className="btn-secondary btn-lg">
									Перейти до каталогу
								</Link>
								<Link href="/books?rent=1#rent-form" className="btn-primary btn-lg">
									Оформити підписку
								</Link>
							</div>
						</div>
						...
						<div className="relative">
							<div className="relative rounded-2xl overflow-hidden shadow-lg group">
								...
								<div className="absolute bottom-4 left-4 space-y-1 z-10">
									<span className="inline-block bg-brand text-neutral-900 px-2 py-[2px] rounded-none text-lg md:text-xl font-semibold leading-tight">
										Family Palace
									</span>
									<span className="block">
										<span className="inline bg-brand text-neutral-900 px-2 py-[1px] rounded-none text-[13px] md:text-sm font-medium leading-tight">Зручна точка видачі книг у центрі міста</span>
									</span>
									<span className="block">
										<span className="inline bg-brand text-neutral-900 px-2 py-[1px] rounded-none text-[13px] md:text-sm font-medium leading-tight">вул. Маріупольська 13/2, Миколаїв</span>
									</span>
								</div>
							</div>
						</div>
