...
export default function ContactLocation({
  ...
  return (
    <section id="pickup-location" className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-gradient-to-b from-slate-50 to-white py-16 lg:py-24">
              ...
              <div className="card p-6 flex flex-col justify-between">
                  ...
                  <ul className="space-y-4 mb-6">
                    {view.bullets.map((b, i) => (
                      <li key={i} className="flex gap-3">
                        <Clock className="mt-1 h-5 w-5 shrink-0 text-slate-600" />
                        <div className="text-base leading-relaxed">
                          {typeof b === 'string' ? (
                            ...
                            <span>
                              ...
                              <span className="text-slate-800 font-medium ml-1">{b.value}</span>
                            </span>
                          ) : null}
                        </div>
                      </li>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-3 text-slate-700 hover:bg-slate-50 transition-colors"
                  >
                ...
                <div className="p-4 bg-slate-50 border-t border-slate-200">
                  <div className="flex flex-col items-center gap-3">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-slate-600">{data.pickup.schedule}</p>
                    </div>
                    <a
                      target="_blank"
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-yellow-500 text-slate-900 rounded-full hover:bg-yellow-400 transition-colors font-semibold shadow-sm hover:shadow-md text-sm"
                    >
