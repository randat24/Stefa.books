...
export default function ContactLocation({
  ...
  return (
    <section id="pickup-location" className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen bg-gradient-to-b from-gray-50 to-white py-16 lg:py-24">
                        ...
                        <div className="text-body leading-relaxed">
                          {typeof b === 'string' ? (
                            ...
                            <span>
                              ...
                              <span className="text-gray-800 font-medium ml-1">{b.value}</span>
                            </span>
                          ) : null}
                        </div>
                      </li>
