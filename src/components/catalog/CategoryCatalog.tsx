          ...
          <div>
            ...
            <div className="space-y-2 ml-6">
              {category.children!.map((subcategory) => (
                ...
                >
                  <span className="w-6 h-6 flex items-center justify-center text-slate-400 group-hover:text-slate-600">
                    📄
                  </span>
  ...
  return (
    <div className={`max-w-4xl mx-auto ${className}`}>
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-900">Повний каталог</h2>
      </div>
