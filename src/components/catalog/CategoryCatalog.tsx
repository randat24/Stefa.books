      ...
      <div key={category.id} className="mb-6">
        ...
        {!hasChildren ? (
          <Link
            ...
            onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleCategoryClick(category, e)}
            ...
            <div className="space-y-2 ml-6">
              {category.children!.map((subcategory) => (
                <Link
                  ...
                  onClick={(e: React.MouseEvent<HTMLButtonElement>) => handleCategoryClick(subcategory, e)}
