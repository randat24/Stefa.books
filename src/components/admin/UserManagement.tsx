            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {filters.search && (
                    <span className="ml-2">
                      • Знайдено: <span className="font-semibold text-gray-900">{filteredUsers.length}</span>
                    </span>
                  )}
                </p>
              </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50 border-b-2 border-gray-200">
                    <TableHead className="w-16 font-semibold text-gray-700 p-4">
                      <div className="flex items-center gap-2">
                        <User className="size-4" />
                        <span className="hidden sm:inline">Аватар</span>
                      </div>
                    </TableHead>
                    <TableHead className="min-w-[200px] font-semibold text-gray-700 p-4">
                      <div className="flex items-center gap-2">
                    ...
                    <TableHead className="min-w-[100px] font-semibold text-gray-700 p-4">
                      <div className="flex items-center gap-2">
                    ...
                    <TableHead className="text-center w-32 bg-gray-100 font-semibold text-gray-800 p-4">
                ...
                <TableBody>
                  {paginatedUsers.map((user, index) => (
                    ...
                    >
                      ...
                      {/* Дії */}
                      <TableCell className="w-32 bg-gray-50 p-4">
                        <div className="flex items-center justify-center gap-1">
                          <button
                            className="group w-8 h-8 rounded-lg bg-gray-600 text-white hover:bg-gray-700 transition-all duration-200 flex items-center justify-center shadow-md hover:shadow-lg hover:scale-110"
                          ...
                          <button
                            className="group w-8 h-8 rounded-lg bg-gray-500 text-white hover:bg-gray-600 transition-all duration-200 flex items-center justify-center shadow-md hover:shadow-lg hover:scale-110"
                          ...
                          <button
                            className="group w-8 h-8 rounded-lg bg-orange-500 text-white hover:bg-orange-600 transition-all duration-200 flex items-center justify-center shadow-md hover:shadow-lg hover:scale-110"
                          ...
                          <button
                            className="group w-8 h-8 rounded-lg bg-red-500 text-white hover:bg-red-600 transition-all duration-200 flex items-center justify-center shadow-md hover:shadow-lg hover:scale-110"
