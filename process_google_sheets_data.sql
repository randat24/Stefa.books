-- Обработка данных из Google Sheets с разделением категорий
-- Этот скрипт обрабатывает категории вида "Пригоди, молодший вік"

-- Функция для разделения категорий и поиска подходящей
...
-- SELECT find_category_by_parts('Пригоди, молодший вік');
...
-- Пример загрузки книг с обработкой категорий
...
-- Проверяем результат
SELECT 
    'Книги загружены с обработкой категорий!' as status,
